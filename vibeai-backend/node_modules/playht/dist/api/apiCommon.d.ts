...
import type { SpeechOptions, SpeechStreamOptions, SpeechOutput, OutputQuality, Emotion, VoiceEngine, PlayHT10OutputStreamFormat, PlayHT20OutputStreamFormat, Play30EngineStreamOptions, OutputFormat } from '..';
...
export type V3ApiOptions = Pick<Play30EngineStreamOptions, 'language' | 'voiceEngine'> & Omit<V2ApiOptions, 'voiceEngine' | 'emotion'>;
