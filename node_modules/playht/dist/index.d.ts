 ...
 */
export type Play30StreamLanguage = 'afrikaans' | 'albanian' | 'amharic' | 'arabic' | 'bengali' | 'bulgarian' | 'catalan' | 'croatian' | 'czech' | 'danish' | 'dutch' | 'english' | 'french' | 'galician' | 'german' | 'greek' | 'hebrew' | 'hindi' | 'hungarian' | 'indonesian' | 'italian' | 'japanese' | 'korean' | 'malay' | 'mandarin' | 'polish' | 'portuguese' | 'russian' | 'serbian' | 'spanish' | 'swedish' | 'tagalog' | 'thai' | 'turkish' | 'ukrainian' | 'urdu' | 'xhosa';
/**
 ...
 * )} Emotion
 */
export type Emotion = 'female_happy' | 'female_sad' | 'female_angry' | 'female_fearful' | 'female_disgust' | 'female_surprised' | 'male_happy' | 'male_sad' | 'male_angry' | 'male_fearful' | 'male_disgust' | 'male_surprised';
/**
 ...
 * options.
 */
export type SpeechOptions = SharedSpeechOptions & (PlayHT20EngineOptions | PlayHT10EngineOptions | StandardEngineOptions);
/**
 * The options available for configuring speech stream, which include shared options combined with engine-specific
 * options.
 */
export type SpeechStreamOptions = SharedSpeechOptions & (PlayDialogEngineStreamOptions | Play30EngineStreamOptions | PlayHT20EngineStreamOptions | PlayHT10EngineStreamOptions | StandardEngineOptions);
/**
 ...
 */
export declare function init(settings: APISettingsInput): void;
/**
 ...
 */
export declare function generate(input: string, options?: SpeechOptions): Promise<SpeechOutput>;
/**
 ...
 */
export declare function stream(input: string | NodeJS.ReadableStream, options?: SpeechStreamOptions): Promise<NodeJS.ReadableStream>;
/**
 ...
 */
export declare function clone(voiceName: string, input: string | Buffer, voiceGender?: VoiceGender, mimeType?: string): Promise<VoiceInfo>;
/**
 ...
 */
export declare function deleteClone(voiceId: string): Promise<string>;
/**
 ...
 */
export declare function listVoices(filters?: VoicesFilter): Promise<Array<VoiceInfo>>;
